...
class RvizVisualizer():
    ...
    def __init__(self, node:Node, callback_group=None, **config_dict):
        ...
        self.marker_pub = self._node.create_publisher(Marker, topic_marker, qos_profile=self._qos_profile)
        self.marker_array_pub = self._node.create_publisher(MarkerArray, topic_marker_array, qos_profile=self._qos_profile)
